...
function Disable-MachineAccount
{
    ...
    if(!$DistinguishedName)
    {
        ...
        Write-Host "[+] Distinguished Name = $distinguished_name"
    }
    else 
    {
...
function New-MachineAccount
{
    ...
    Write-Host "[+] SAMAccountName = $sam_account" 
...
function Disable-ADIDNSNode
{
    ...
    Write-Host "[+] DNSRecord = $([System.Bitconverter]::ToString($DNS_record))"
   ...
   .PARAMETER Data
    ...
    if(!$DNSRecord)
    {
        ...
        try 
        {
            ...
            Write-Host "[+] DNSRecord = $([System.Bitconverter]::ToString($DNSRecord))"
        }
        catch
        {
            Write-Output "[-] $($_.Exception.Message)"
...
function Get-ADIDNSZone
{
    ...
    {
        Write-Host "[+] Partition = $partition_entry"
...
function Get-KerberosAESKey
{
    ...
    Write-Host "PBKDF2 AES128 Key: $PBKDF2_AES128_key_string"
    Write-Host "PBKDF2 AES256 Key: $PBKDF2_AES256_key_string"
